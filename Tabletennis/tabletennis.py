...
# Create the scene and set its title
...
net = box(pos=vector(0.1, 0.5, 0), length=0.1, height=0.3, width=15.2, color=vector(0, 2, 2))
net = box(pos=vector(-0.1, 0.5, 0), length=0.1, height=0.3, width=15.2, color=vector(0, 2, 2))

# Create the net bars
net_bar = box(pos=vector(0, 0.87, 0), length=0.3, height=1.9, width=0.4, color=color.black)
net_barl = box(pos=vector(0, 0.87, -7.6), length=0.3, height=1.9, width=0.4, color=color.black)
net_barr = box(pos=vector(0, 0.87, 7.6), length=0.3, height=1.9, width=0.4, color=color.black)

# Create the floor
floor = box(pos=vector(0, -7.6, 0), length=35.4, height=0.5, width=18, color=color.orange)

# Create the player's rackets
